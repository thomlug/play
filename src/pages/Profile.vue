            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="profile-block">
                    ...
                    <div class="player-profile-content">
                        <img v-if="player.photo" class="profile-photo" :src="player.photo"
                                        ...
                                        <div id="hide">
                                            <label class="hand-cursor">
                                                <input type="file" :name="uploadFieldName" :disabled="isSaving"
                                                       @change="filesChange" accept="image/*" class="input-file">
                        ...
                        <div class="content-block">
                            ...
                            <input placeholder="Preferred position" :maxlength="25" v-if="editable"
                                   v-model="player.preffered_position"/>
                        </div>
                        <div class="content-block">
                            <div class="input-header" v-if="editable">
                                <h6> Jersey Number</h6>
                            ...
                            <input placeholder="Jersey number" :maxlength="3" v-if="editable"
                ...
                <div class="profile-block">
                    <div class="content-block">
                        ...
                        <div class="profile-info"><i class="fa fa-phone" v-if="!editable"></i>
                            <a v-if="!editable && (player.phone != null || player.phone !== '')"
                               :href="'tel:'+player.phone">{{player.phone}} </a>
                            <span v-if="!editable && (player.phone == null || player.phone === '')">No number</span>
                            <input placeholder="Phone number" :maxlength="15" v-if="editable" v-model="player.phone"/>
                        </div>
                    </div>
                ...
                <div v-if="canEditProfile() && !editable">
                    <div class="profile-block">
                        ...
                        <div v-for="team in player.teams" :key="team.teamKey" class="availability-container row">
                            ...
                            <div>
                                <button v-on:click="setCurrentPlayerAvailability('available', team.teamKey)"
                                        type="button"
                                        class="btn btn-primary btn-available col-md-4 btn-round-tick fa fa-check"></button>
                                <button v-on:click="setCurrentPlayerAvailability('unavailable', team.teamKey)"
                                        type="button"
                                        class="btn btn-danger col-md-4 btn-round-cross fa fa-times"></button>
                            </div>
                        </div>
                    </div>
                </div>
